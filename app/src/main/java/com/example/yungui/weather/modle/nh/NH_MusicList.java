...
public class NH_MusicList {
    ...
    public static List<NH_MusicList> arrayNH_MusicListFromData(String str) {

        Type listType = new TypeToken<ArrayList<NH_MusicList>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<NH_MusicList> arrayNH_MusicListFromData(String str, String key) {
    ...
    public static class DataBean {
         ...
         * share_info : {"url":"http://m.wufazhuce.com/music/1181","image":"http://image.wufazhuce.com/FhUM1zhDnX3qWfLCL7XG4ZuyBHYY","title":"「一个」音乐: 大忘路 You Don't Trust Me At All","content":"了啊。"}
