...
public class ConstUtils {
    ...
    /*******************内涵首页****************************/
    public static final String Category_Pic = "0";
    public static final String Category_OneWeek = "1";
    public static final String Category_Essay = "1";
    public static final String Category_Music = "4";
    public static final String Category_Movie = "5";
    ...
    public static final String KEY_EXTRA_GIRLS_FROM = "from";
    public static final String KEY_EXTRA_GIRLS_GILRS = "girls";
    /**
     * Byte与Byte的倍数
     */
