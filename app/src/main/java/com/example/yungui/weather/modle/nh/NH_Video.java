...
public class NH_Video {
    ...
    public static NH_Video objectFromData(String str) {

        return new Gson().fromJson(str, NH_Video.class);
    }

    public static NH_Video objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), NH_Video.class);
    ...
    public static List<NH_Video> arrayNH_VideoFromData(String str) {

        Type listType = new TypeToken<ArrayList<NH_Video>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<NH_Video> arrayNH_VideoFromData(String str, String key) {
