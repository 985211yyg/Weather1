...
public interface NHController {
     ...
     *
     获取首页的列表item
     */
    @GET("http://v3.wufazhuce.com:8000/api/essay/{item_id}?channel=wdj&source=summary&source_id=9261&version=4.0.2&uuid=ffffffff-a90e-706a-63f7-ccf973aae5ee&platform=android")
