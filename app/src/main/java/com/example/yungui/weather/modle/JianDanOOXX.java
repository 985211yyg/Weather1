...
public class JianDanOOXX {
    ...
    public static JianDanOOXX objectFromData(String str) {

        return new Gson().fromJson(str, JianDanOOXX.class);
    }

    public static JianDanOOXX objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), JianDanOOXX.class);
    ...
    public static List<JianDanOOXX> arrayJianDanOOXXFromData(String str) {

        Type listType = new TypeToken<ArrayList<JianDanOOXX>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<JianDanOOXX> arrayJianDanOOXXFromData(String str, String key) {
